...
<div class="row">
  ...
  <div class="col-md-12 splash-header p-0"  style="background-image: url(<?php echo $header_img['url'] ?>); position: relative;">
    ...
    <div class="col-md-7 db-install-gradient text-center p-5" >
    ...
    <div class="col-sm-5 p-4 light-blue-background">
         ...
         <div class="col-md-11 ho-offer1-copy">
           <div class="row mx-0 align-items-center">
             <div class="ho-offer1 col-lg-11 offset-lg-1 offset-md-2">
               <h2 style="color:#000">Precision Building Solutions offers a wide range of engineering services, including:</h2>
             </div>
           <?php
...
<div class="row blue-background" style="color: #fff">
  <div class="col-lg-12 text-center p-3">
    <h4>Trust in Precision Building Solutions:</h4>
  </div>
  <div class="col-lg-5 trust-install my-auto">
      <div class="row align-items-center">
        <div class="col-lg-4 px-0">
          <img src="<?php echo $installation_masters['url'] ?>" alt="#">
        </div>
          <div class="trust-install-copy col-lg-8 pl-md-0">
            <p>We staff California and Nevada State-Licensed Engineers, as well as members of the SEAOC (Structural Engineer’s Association of California).</p>
          </div>
      </div>
    </div>
  ...
  <div class="row dealer-container justify-content-center" style="background-image: url(<?php echo $footer_img['url'] ?>);" >
    ...
    <div class="ho-dealer-overlay-inner desk-bot-hero" >
      <div class="overlay-textwrap overlay-textwrap-dk">
